<?php
require_once __DIR__ . '/CryptoCurrencyPHP/PointMathGMP.class.php';
require_once __DIR__ . '/CryptoCurrencyPHP/SECp256k1.class.php';
require_once __DIR__ . '/CryptoCurrencyPHP/Signature.class.php';
